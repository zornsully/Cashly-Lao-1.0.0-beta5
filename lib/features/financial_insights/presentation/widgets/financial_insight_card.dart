          ...
          Column(
            ...
            children: [
              TextButton.icon(
                ...
                icon: const Icon(AppSymbols.infoOutline, size: 18),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(AppSymbols.infoOutline, color: colors.primary),
          const SizedBox(width: AppSpacing.sm),
