...
import '../../domain/entities/account_spending.dart';

/// A donut chart summarizing one currency's "Spending by Account", paired
/// with a text legend below it — so account identity is never carried by
/// color alone. Same shape as [CategoryPieChart], one level up (by account
/// instead of category); kept as a separate widget rather than a generic
/// one because the two operate on different entity types with different
/// color/name sources.
class AccountPieChart extends StatelessWidget {
  ...
  final List<AccountSpending> spending;
