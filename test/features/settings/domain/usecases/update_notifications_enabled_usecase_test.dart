...
import 'package:cashly_lao/features/settings/domain/usecases/update_notifications_enabled_usecase.dart';
...
void main() {
  ...
  setUp(() {
    ...
    useCase = UpdateNotificationsEnabledUseCase(repository);
  });
  ...
  test('delegates to the repository and returns its result', () async {
    ...
    verify(() => repository.updateNotificationsEnabled(true)).called(1);
  });
}
