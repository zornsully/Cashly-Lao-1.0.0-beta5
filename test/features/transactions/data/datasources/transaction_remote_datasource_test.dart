...
void main() {
  ...
  group('transfers', () {
    ...
    test('createTransaction succeeds when source and destination share a '
        'currency', () async {
    ...
    test('createTransaction throws and leaves balances untouched when source '
        'and destination use different currencies', () async {
      final accountA = await seedAccount(100, currencyCode: 'USD');
    ...
    test('updateTransaction throws when edited to a destination in a '
        'different currency, leaving balances untouched', () async {
      final accountA = await seedAccount(100, currencyCode: 'USD');
      final accountB = await seedAccount(50, currencyCode: 'USD');
